...
import { useSmoothTransform } from "./useSmoothTransition"
...
type LightRotationFunction = (v: number) => number;
...
const mouseToLightRotation: LightRotationFunction = (v) => (-1 * v) / 140;
...
export function Lights() {
  return (
    <>
      ...
      <spotLight color="#dd2c2c" position={[15, 10, -2]} intensity={2} />
      <spotLight color="#dd2c2c" position={[15, 10, 5]} intensity={1} />
      <spotLight color="#ff0000" position={[5, -10, 5]} intensity={0.8} />
    </>
  );
}
