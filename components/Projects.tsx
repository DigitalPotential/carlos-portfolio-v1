...
import { countriesRestApi, spotify, DigitalWeb, netflixclone } from "@/public/assets";
                    ...
                    <div className="flex flex-col xl:flex-row gap-6">
                        ...
                        <div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between xs:items-end xs:text-right z-10">
                            ...
                            <p className="bg-[#112240] text-sm md:text-base p-4 xl:-ml-16 md:p-6 rounded-lg text-white">
                                This website was built for my agency with
                                Webflow, on this site you can see all the
                                services we offer and the work we have done. For
                                this site I used webflows native animations and
                                interactions to create a smooth user experience
                                aswell as custom code to style the scrollbar,
